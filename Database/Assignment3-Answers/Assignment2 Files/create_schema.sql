...
Mechanic_id NUMBER NOT NULL PRIMARY KEY,
last_name VARCHAR2(20) NOT NULL,
first_name VARCHAR(20) NOT NULL
);

CREATE TABLE Service(
Service_id NUMBER NOT NULL PRIMARY KEY,
Servive_Name VARCHAR2(20) NOT NULL,
Hourly_Rate NUMBER NOT NULL
);

CREATE TABLE parts(
Parts_id NUMBER NOT NULL PRIMARY KEY,
...
ServiceTicket_id NUMBER NOT NULL
...
ServiceMechanic_id NUMBER NOT NULL
